...
def test_get_offer(client):
    ...
    assert response.json() == {
        ...
        "images": [
            "http://domain.com//mediafiles/image(1)_H802r7h.jpeg",
            "http://domain.com//mediafiles/image(2)_bGKHdms.jpeg",
            "http://domain.com//mediafiles/image(3)_PV4BY6L.jpeg",
            "http://domain.com//mediafiles/image(4)_SCiBiMz.jpeg",
            "http://domain.com//mediafiles/5_zDDUs4j.jpg",
            "http://domain.com//mediafiles/4_QsbenAd.jpg",
            "http://domain.com//mediafiles/3_5vqrqhm.jpg",
            "http://domain.com//mediafiles/2_5jbRqfd.jpg",
            "http://domain.com//mediafiles/1_RrQEWYc.jpg",
        ],
        "is_deliverable": True,
        "is_favorite": False,
        "is_promoted": True,
...
def test_get_my_offers(client, auth_token):
    ...
    assert response.json() == {
        "data": [
            ...
            {
                "cover_image": "http://domain.com//mediafiles/0_PrBB7kx.jpg",
                "currency": None,
                "description": "sfsdsdf",
                "functions": ["DO_ACTIVE", "ARCHIVE"],
